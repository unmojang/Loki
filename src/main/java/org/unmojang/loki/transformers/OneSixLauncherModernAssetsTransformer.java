...
public class OneSixLauncherModernAssetsTransformer extends LokiTransformer {

    protected boolean matches(String className) {
        return "net/minecraft/launcher/updater/VersionManager".equals(className)
                || "net/minecraft/launcher/GameLauncher".equals(className)
                || "net/minecraft/launcher/updater/download/Downloadable".equals(className)
                || "net/minecraft/launcher/updater/PreHashedDownloadable".equals(className);
    }
