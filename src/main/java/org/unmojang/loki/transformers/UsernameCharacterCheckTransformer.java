...
public class UsernameCharacterCheckTransformer extends LokiTransformer {

    protected boolean matches(String className) {
        return !Loki.username_validation && !className.startsWith("java/") && !className.startsWith("javax/");
    }
