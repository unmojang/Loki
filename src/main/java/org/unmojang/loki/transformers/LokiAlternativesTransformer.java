...
public class LokiAlternativesTransformer extends LokiTransformer {

    protected boolean matches(String className) {
        return LokiUtil.JAVA_MAJOR > 5
                && (className.equals("moe/yushi/authlibinjector/transform/ClassTransformer") ||
                ...
                className.startsWith("org/prismlauncher/legacy/fix/online/"));
    }
